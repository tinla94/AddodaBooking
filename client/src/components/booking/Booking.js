  ...
  render() {
    ...
    return (
      <div className='booking'>
        ...
        <hr></hr>
        { !isAuth &&
          <Link className='button button-dark-gray button-link btn-block' to={{pathname: '/login'}}>
            Login to book place.
          </Link>
        }
        { isAuth &&
          <React.Fragment>
            ...
            <button disabled={!startAt || !endAt || !guests} onClick={() => this.confirmProposedData()} className='button button-dark-gray btn-block'>Reserve place now</button>
          </React.Fragment>
        }
        <hr></hr>
